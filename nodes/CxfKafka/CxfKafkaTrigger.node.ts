...
import { nodeConnectionTypes as NodeConnectionTypes, NodeOperationError } from 'n8n-workflow';

export class CxfKafkaTrigger implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'CXF Kafka Trigger',
		name: 'cxfKafkaTrigger',
		icon: { light: 'file:cxfKafka.svg', dark: 'file:cxfKafka.dark.svg' },
		group: ['trigger'],
		version: [1, 1.1],
		description: 'Consume messages from a Kafka topic, with schema registry authentication support',
		defaults: {
			name: 'CXF Kafka Trigger',
		},
		inputs: [],
