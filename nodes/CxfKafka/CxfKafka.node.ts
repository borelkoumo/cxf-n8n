...
import { ApplicationError, nodeConnectionTypes as NodeConnectionTypes, NodeOperationError } from 'n8n-workflow';

import { generatePairedItemData } from '../../utils/utilities';

export class CxfKafka implements INodeType {
	description: INodeTypeDescription = {
		displayName: 'CXF Kafka',
		name: 'cxfKafka',
		icon: { light: 'file:cxfKafka.svg', dark: 'file:cxfKafka.dark.svg' },
		group: ['transform'],
		version: 1,
		description: 'Sends messages to a Kafka topic with schema registry authentication support',
		defaults: {
			name: 'CXF Kafka',
		},
		usableAsTool: true,
